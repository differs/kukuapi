  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        upstreamWireAPI: 'Upstream API',
        upstreamWireAPIDesc: 'Choose which OpenAI-compatible upstream protocol this API Key account should call.',
        upstreamWireAPIResponses: 'Responses API',
        upstreamWireAPIChatCompletions: 'Chat Completions',
