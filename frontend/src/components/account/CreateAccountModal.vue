<template>
  ...
  >
    ...
    >
      ...
      <div
        v-if="form.platform === 'openai' && (accountCategory !== 'apikey' || !isOpenAIChatCompletionsUpstream)"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
        <div class="flex items-center justify-between">
          <div>
      ...
      <div
        v-if="form.platform === 'openai' && (accountCategory === 'oauth-based' || (accountCategory === 'apikey' && !isOpenAIChatCompletionsUpstream))"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
        <div class="flex items-center justify-between">
          <div>
...
const isOpenAIChatCompletionsUpstream = computed(() =>
  form.platform === 'openai' && accountCategory.value === 'apikey' && openAIUpstreamWireAPI.value === OPENAI_UPSTREAM_WIRE_API_CHAT_COMPLETIONS
)
...
const canUseOpenAIPassthrough = computed(() =>
  form.platform === 'openai' && (accountCategory.value !== 'apikey' || !isOpenAIChatCompletionsUpstream.value)
)
...
const buildOpenAIExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
  ...
  if (accountCategory.value === 'oauth-based') {
    ...
    delete extra.openai_upstream_wire_api
  } else if (accountCategory.value === 'apikey') {
    if (openAIUpstreamWireAPI.value === OPENAI_UPSTREAM_WIRE_API_CHAT_COMPLETIONS) {
      extra.openai_upstream_wire_api = OPENAI_UPSTREAM_WIRE_API_CHAT_COMPLETIONS
